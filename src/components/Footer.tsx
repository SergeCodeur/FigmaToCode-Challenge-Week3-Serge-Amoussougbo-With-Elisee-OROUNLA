...
import FootBlock from "./ui/footblock";
...
export const Footer = () => {
  ...
  return (
    <div className="bg-white">
            <div className="">
        <div className="border-b border-gray-80 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl  flex flex-col justify-between pt-5 pb-10 px-4 sm:flex-row">
          <p className="text-md font-bold text-text_color font-montserrat">
            Bandage
          </p>
          <div className="flex items-center mt-4 space-x-4 sm:mt-0 text-primary">
              <Link
                href="/"
        ...
        <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
          ...
          <div className="md:max-w-md lg:col-span-2 mb-12">
            ...
            <p className="mt-4 text-sm text-gray-500">
              lorem ipsum dolor amet short ribs pig sausage
            </p>
          </div>
        </div>
      </div>
